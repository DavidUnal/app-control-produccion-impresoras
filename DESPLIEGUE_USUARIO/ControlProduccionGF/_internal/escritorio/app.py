...
from PySide6.QtWidgets import (
    ...
    QSizePolicy, QInputDialog, QGraphicsDropShadowEffect, QSpacerItem, QToolButton,
    QStackedLayout
)
from PySide6.QtGui import (
    QDesktopServices, QShortcut, QKeySequence, QIcon, QPixmap, QFont, QAction, QColor
)
    ...
    def _buscar(self):
        ...
        for a in anchos:
            ...
            for m in marcas:
                ...
                rows = self._inv_get("/inventario/existencias", params)  # ✅ endpoint real
                for rr in rows:
                    self._add_exist_row(
                        mat_txt,
    ...
    def _buscar(self):
        ...
        for an in anchos:
            ...
            for mk in marcas:
                ...
                rows = self._inv_get("/inventario/laminados/existencias", params)  # ✅ endpoint real
                for rr in rows:
...
class PagReportes(QWidget):
    ...
    def _calc_consumo_esperado(self, r: dict) -> float:
        ...
        if imp <= 0:
            # fallback por si el backend manda el largo impreso en LARGO
    ...
    def _load(self):
        ...
        # ✅ 1.1) Política: Finalizadas visibles hasta 6 meses (por ENTREGA preferida)
        #     (si el combo está en "Todas", también aplica igual a las finalizadas)
        ...
        # ✅ Usamos ENTREGA como fecha principal del filtro UI, con fallback a FECHA
        ...
        filtered = []
        for r in rows:
            # ✅ ahora filtra por ENTREGA (o FECHA si no hay)
    ...
    def _filtrar_finalizadas_ultimos_6_meses(self, rows):
        """Deja FINALIZADAS con ENTREGA >= hoy-6meses (fallback a FECHA)."""
